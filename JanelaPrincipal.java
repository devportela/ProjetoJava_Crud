...
public class JanelaPrincipal extends JFrame {
    ...
    private void criarMenus() {
        ...
        // RELATÓRIOS
        itemRelCliente.addActionListener(e -> gerarRelatorioClientes());
    ...
    private void abrirCadastroProduto() {
        ...
        //so trocar por : "new TelaCadastroProduto();"
    }
    ...
    private void deletarProduto() {
        ...
        //so trocar por: dao.deletar(id)"
    }

    private void listarProdutos() {
        JOptionPane.showMessageDialog(this, "LISTAR PRODUTOS");
        //so trocar por: dao.listar"//
    }


    private void gerarRelatorioClientes() {
        JOptionPane.showMessageDialog(this, "GERAR RELATÓRIO DE CLIENTES");
    }
